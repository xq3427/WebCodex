...
const sectionSchema = {
  ...
  sessions: z.object({ enabled: z.boolean().optional(), directory: text.optional(), retentionDays: integer.optional(), maxEvents: integer.optional(), maxBytes: integer.optional(), recordToolArguments: z.enum(['none','redacted']).optional(), recordToolResults: z.enum(['none','summary']).optional(), remindBeforeFinalReply: z.boolean().optional(), journalStatusInToolResults: z.boolean().optional(), stalePendingMinutes: integer.optional() }).strict(),
