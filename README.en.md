...
With Node.js ≥22.16 and npm already installed, run the [npm release](https://www.npmjs.com/package/webcodex-mcp/v/0.16.0-preview.10) from a new dedicated directory outside the source checkout; no npm login is needed:
